...
const EXIT_SCENE_PATH: String = "res://level/dungeon_exit.tscn"
...
func get_exit_scene_path() -> String:
	return EXIT_SCENE_PATH

func get_approved_scene_paths() -> PackedStringArray:
	return PackedStringArray([FLOOR_SCENE_PATH, WALL_SCENE_PATH, ENTRANCE_SCENE_PATH, EXIT_SCENE_PATH])
...
func is_valid_for_role(tile_role: String, scene_path: String) -> bool:
	...
	if tile_role == "exit":
		return scene_path == EXIT_SCENE_PATH
