...
Goblins exist as catalog monsters with aggro/attack states aimed at characters. Buildings exist as enabled scenes under a building root with collision, but they have no health and are not goblin targets. Spawning goblins is already a DM HUD action (currently paid with Fantasy Level; mana is US-014). **Spawn placement near the DM** (random walkable radius) is **[US-055](US-055.md)** — this story owns raid/destroy behavior only.
