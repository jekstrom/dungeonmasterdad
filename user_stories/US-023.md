...
Occupancy (who may stand or build) remains US-001 / US-003. Dungeon start/exit remains US-015.
...
- **FR-006**: Overworld fill / match start MUST place outside tiles only on cells outside dungeon bounds.
...
- Trees (US-006) and mines (US-007) sit on outside tiles, not on dungeon floors.
