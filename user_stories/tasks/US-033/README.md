...
| [T009](T009-verification-harness.md) | Headless + two-window play pass | QA / Gameplay | T003–T007 | |
...
PP A explores; PP B sees the same reveal. DM explores separately; sets stay isolated. Markers and buildings follow the defaults table. `M` toggles. Late-join PP gets shared snapshot.
