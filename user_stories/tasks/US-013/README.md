...
James signed at `7d868d8`. **Behavior add (still Signed):** 2× move speed, walkable-only pathing + **inland / away-from-cliff bias**, staples damage, always flee PPs. Gremlins pick up and drop world resources. **Gremlins ≠ goblins** — dedicated scene, sprites, VFX, HUD/skill icons. No goblin asset reuse.
...
| [T003](T003-pathing-and-target-prefer.md) | Walkable-only + inland/cliff-away bias; prefer factories/IRS; always flee PPs | Gameplay | T002 | |
...
| [T006](T006-verification-harness.md) | Spawn≠goblin; relocate; speed; walkable; inland bias; staples; flee; multiplayer | QA / Gameplay | T002–T005, T007–T008 | |
